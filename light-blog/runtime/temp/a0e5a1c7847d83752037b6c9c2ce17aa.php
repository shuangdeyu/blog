<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/data/wwwroot/www.shuangdeyu.com/jyj/application/index/view/admin/movie_edit.html";i:1497574935;s:77:"/data/wwwroot/www.shuangdeyu.com/jyj/application/index/view/public/admin.html";i:1499046364;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="<?php echo url('index/admin/movie_update'); ?>" method="post" enctype="multipart/form-data">
        <input type="hidden" value="<?php echo $movie['id']; ?>" name="mid">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $movie['title']; ?>" placeholder=""  name="title">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                    <textarea id="movieContent" name="content" style="width:740px;height:500px;"><?php echo $movie['content']; ?></textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="hidden" name="cover" value="<?php echo $movie['cover']; ?>" />
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">更换封面：</label>
            <div class="formControls col-xs-8 col-sm-9">
