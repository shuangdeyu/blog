<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\wamp\www\jyj/application/index\view\admin\photo_add.html";i:1497665961;s:56:"D:\wamp\www\jyj/application/index\view\public\admin.html";i:1499046364;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="<?php echo url('index/admin/photo_save'); ?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="type" value="<?php echo $type; ?>" />
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                    <textarea id="movieContent" name="content" style="width:740px;height:500px;"></textarea>
            </div>
        </div>
