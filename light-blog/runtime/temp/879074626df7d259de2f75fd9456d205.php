<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp\www\light-blog/application/index\view\admin\movie_show.html";i:1497794718;s:63:"D:\wamp\www\light-blog/application/index\view\public\admin.html";i:1497521267;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-mivie">
            ...
            <dd style="display: block">
                <ul>
                    <li class="current"><a href="<?php echo url('index/admin/movie_show'); ?>" title="影评">影评</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-photo">
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加影评" onclick="movie_add('添加影评','movie_add.html','10001')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加影评</a>
				</span>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody>
                    <?php if(is_array($movie) || $movie instanceof \think\Collection || $movie instanceof \think\Paginator): $i = 0; $__LIST__ = $movie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c va-m">
                            <td><input name="" type="checkbox" value=""></td>
                            <td><?php echo $vo['id']; ?></td>
                            <td class="text-c">
                                <a onClick="movie_show('<?php echo $vo['title']; ?>','movie_info?id=<?php echo $vo['id']; ?>',900,700)" href="javascript:void(0);"><?php echo $vo['title']; ?></a>
                            </td>
                            <td class="text-l">
                            ...
                            <td class="td-manage">
                                <a style="text-decoration:none" class="ml-5" onClick="movie_edit('编辑影评','movie_edit.html?id=<?php echo $vo['id']; ?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a style="text-decoration:none" class="ml-5" onClick="movie_del(this,'10001','/jyj/admin/movie_del','<?php echo $vo['id']; ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
                            </td>
                        </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
                <?php echo $movie->render(); ?>
            </div>
        </article>
    </div>
</section>
