<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/data/wwwroot/www.shuangdeyu.com/jyj/application/index/view/admin/weibo_add.html";i:1497432840;s:77:"/data/wwwroot/www.shuangdeyu.com/jyj/application/index/view/public/admin.html";i:1497521267;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="<?php echo url('index/admin/weibo_save'); ?>" method="post">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea id="articleContent" name="content" style="width:740px;height:500px;"></textarea>
            </div>
        </div>
        <div class="row cl">
