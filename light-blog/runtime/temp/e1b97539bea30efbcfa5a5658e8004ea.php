<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/data/wwwroot/www.shuangdeyu.com/jyj/application/index/view/admin/weibo_info.html";i:1497432853;s:77:"/data/wwwroot/www.shuangdeyu.com/jyj/application/index/view/public/admin.html";i:1497521267;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="<?php echo url('index/admin/weibo_edit'); ?>" method="post">
        <input type="hidden" value="<?php echo $weibo['id']; ?>" name="id">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $weibo['name']; ?>" placeholder=""  name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">链接：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $weibo['link']; ?>" placeholder=""  name="link">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea id="articleContent" name="content" style="width:740px;height:500px;"><?php echo $weibo['content']; ?></textarea>
            </div>
        </div>
        <div class="row cl">
